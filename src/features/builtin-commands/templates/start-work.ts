...
1. **Find available plans**: Search for Prometheus-generated plan files at \`.musashi/plans/\`

2. **Check for active boulder state**: Read \`.musashi/boulder.json\` if it exists

3. **Decision logic**:
   - If \`.musashi/boulder.json\` exists AND plan is NOT complete (has unchecked boxes):
