...
export const linearisSkill: BuiltinSkill = {
  name: "linearis",
  description:
    "(opencode - Skill) Linear CLI tool for issue tracking. Use for creating, listing, updating issues, projects, and cycles. Optimized for LLMs with JSON output.",
  template: `# Linearis Skill
