...
export const DELEGATE_TASK_ERROR_PATTERNS: DelegateTaskErrorPattern[] = [
  ...
  },
  {
    ...
    fixHint: "Provide ONLY one of: category (e.g., 'general', 'quick') OR subagent_type (e.g., 'K9 - advisor', 'X1 - explorer')",
  },
  {
    pattern: "Must provide either category or subagent_type",
    errorType: "missing_category_or_agent",
    fixHint: "Add either category='general' OR subagent_type='X1 - explorer'",
  },
  {
  ...
  },
  {
    ...
    fixHint: "Primary agents cannot be called via delegate_task. Use a subagent like 'X1 - explorer', 'K9 - advisor', or 'R2 - researcher'",
  },
  {
...
delegate_task(
  ...
  category="general",  // OR subagent_type="X1 - explorer"
