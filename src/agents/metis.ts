...
\`\`\`
// Parallel probes
call_omo_agent(subagent_type="X1 - explorer", prompt="Find how X is currently handled...")
call_omo_agent(subagent_type="R2 - researcher", prompt="Find official docs for Y...")
